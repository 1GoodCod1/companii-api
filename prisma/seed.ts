...
const CATEGORIES: { name: string; slug: string }[] = [
  ...
  { name: 'Climatizare și încălzire', slug: 'kondicionery-otoplenie' },
  { name: 'Lucrări de finisaj', slug: 'otdelochnye-raboty' },
  { name: 'Lucrări cu plăci ceramice', slug: 'plitka' },
  { name: 'Acoperiș și fațadă', slug: 'krovlya-fasad' },
  { name: 'Ferestre și uși', slug: 'okna-dveri' },
  { name: 'Reparații electrocasnice', slug: 'bytovaya-tehnika' },
  { name: 'Instalare echipamente', slug: 'ustanovka-tehniki' },
  { name: 'Meșter pentru o oră', slug: 'master-na-chas' },
  { name: 'Curățenie', slug: 'uborka' },
  { name: 'Mobilier', slug: 'mebel' },
  { name: 'Internet și videosecuritate', slug: 'internet' },
  { name: 'Service auto', slug: 'avto' },
  { name: 'Transport marfă și mutări', slug: 'pereezdy' },
  { name: 'Peisagistică și grădină', slug: 'landshaft' },
  { name: 'Panouri solare', slug: 'panouri-solare' },
  { name: 'Tâmplărie', slug: 'tamplarie' },
  { name: 'Evacuare gunoi', slug: 'vyvoz-musora' },
  { name: 'Fântâni și fose septice', slug: 'fantani-puturi' },
];
