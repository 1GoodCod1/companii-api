...
export const climaBlueprint: EstimateBlueprintConfig = baseConfig({
    ...
    customFields: [
      ...
      },
      {
        ...
        required: false,
        defaultValue: false,
        helpText: 'Aplică coeficient 1.25 la manoperă.',
        section: 'Montaj',
      },
      {
        key: 'requiresPump',
    ...
    pricingRules: [
      ...
      { stageCode: 'traseu', description: 'Traseu standard — manoperă', unit: 'm', qtyKey: 'routeStandardLengthMLabor', unitPrice: 80, kind: 'labor', moduleKey: 'route' },
      ...
      { stageCode: 'traseu', description: 'Traseu suplimentar — manoperă', unit: 'm', qtyKey: 'routeExtraLengthMLabor', unitPrice: 95, kind: 'labor', moduleKey: 'route', enabledWhen: { anyQtyKeys: ['routeExtraLengthM'] } },
      ...
      { stageCode: 'traseu', description: 'Manoperă drenaj condens', unit: 'm', qtyKey: 'drainLengthMLabor', unitPrice: 45, kind: 'labor', moduleKey: 'drain' },
      ...
      { stageCode: 'montaj', description: 'Manoperă instalare split AC', unit: 'buc', qtyKey: 'acUnitsLabor', unitPrice: 1200, kind: 'labor', moduleKey: 'indoor_outdoor_units' },
